    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[640px]'>
        ...
        <div className='flex gap-3'>
          <input className='border border-zinc-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='First name' />
          <input className='border border-zinc-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Last name' />
        </div>
        <input className='border border-zinc-300 rounded py-1.5 px-3.5 w-full' type="email" placeholder='Email address' />
        <input className='border border-zinc-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Street' />
        <div className='flex gap-3'>
        ...
        <div className='flex gap-3'>
          <input className='border border-zinc-300 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Zip code' />
          <input className='border border-zinc-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Country' />
        </div>
        <input className='border border-zinc-300 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Phone' />
      </div>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12 '>
          ...
          <div className='w-full text-end mt-8'>
            <button onClick={() => navigate('/orders')} className='bg-yellow-500 text-black px-16 py-3 text-sm'>PLACE ORDER</button>
          </div>
